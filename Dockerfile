...
RUN         apt -y update \
            ...
            && apt -y update \
            && apt install -y libncurses5 lib32ncurses5 libgl1 libglu1-mesa libgsm1 libodbc1 libosmesa6 libsane libsane1 libsdl2-2.0-0 libv4l-0 libxcomposite1 libxcursor1 libxfixes3 libxi6 libxinerama1 libxrandr2 libxrandr2 libxrender1 libxxf86vm1 \
